...
(function(exports) {
  var ScreenManager = {
    ...
    */
	...
	dump('##############################################################_screenAutoBrightness.onbrightnesschange:' + brightness);
      ...
      function brightnessSettingChanged(value) {
        dump('##############################################################brightnessSettingChanged:' + value);
      ...
      Service.register('turnShadeOn', this);
    ...
    setScreenBrightness: function scm_setScreenBrightness(brightness, instant) {
      ...
      dump('##############################################################power.screenBrightness:' + brightness + '  mode:' + instant);
      //window.asyncStorage.setItem('ittat.cachebrightness', brightness);
	...
	dump('##################################setDeviceLightEnabled:' + this._userBrightness);
