    ...
    if (evt.type === 'softwareButtonEvent') {
      ...
      switch (type) {
        ...
        case 'volume-down-button-release':
         case 'xtop-button-release':
         case 'xtop-button-press':
         case 'xmid-button-release':
         case 'xmid-button-press':
         case 'xbottom-button-release':
         case 'xbottom-button-press':
  ...
  HardwareButtonsBaseState.prototype.process = function(type) {
    switch (type) {
      ...
      case 'volume-down-button-press':
        ...
        return;
      case 'xtop-button-press':
  	dump('##############################tristatetop-button-press');
 	this.hardwareButtons.publish('mute');
        return;
       case 'xmid-button-press':
  	dump('###############################tristatemid-button-press');
 	this.hardwareButtons.publish('setvibration');
        return;
       case 'xbottom-button-press':
  	dump('##############################tristatebottom-button-press');
 	this.hardwareButtons.publish('unmute');
	this.hardwareButtons.publish('offvibration');
         return;
