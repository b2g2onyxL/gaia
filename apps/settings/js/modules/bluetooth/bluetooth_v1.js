...
define(function(require) {
  ...
  var bluetoothPrototype = {
	...
	var bluetoothManager1;
    	bluetoothManager1 = window.navigator.mozBluetooth;
    	debug("navigator.mozBluetooth is " +
       	 (bluetoothManager1 ? "available" : "unavailable"));

       debug('NavigatorBluetooth:' + NavigatorBluetooth );
      debug('this.enabled:' + this.enabled );
	...
	debug('_initAddressInfo');
	debug('this.address:' + this.address );
	debug('this.enabled:' + this.enabled );
	...
	debug('self.address:' + self.address );
