    ...
    return SettingsPanel({
      onInit: function(panel) {
        ...
        elements = {
          ...
          // ssrSettingBtn:
          //   panel.querySelector('#ssr-settings-section a'),
          hotspotElement:
      ...
      onBeforeShow: function(panel, options) {
        ...
        // elements.ssrSettingBtn.addEventListener('click',
        //   this._onSsrSettingsClick);
      ...
      onBeforeHide: function(panel, options) {
        ...
        // elements.ssrSettingBtn.removeEventListener('click',
        //   this._onSsrSettingsClick);
      ...
      // _onSsrSettingsClick: function() {
      //   DialogService.show('ssr-detailSettings', {
      //     settings: hotspotSettings //?
      //   }).then((result) => {
      //     if (result.type === 'submit') {
      //       // reconnect hotspot settings to make new settings take effect.
